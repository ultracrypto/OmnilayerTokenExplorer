    ...
    public partial class CoinService
    {
        ...
        public class CoinParameters
        {
                ...
                short rpcRequestTimeoutInSeconds)
            {
                ...
                {
                   RpcRequestTimeoutInSeconds = LibConfig.RpcRequestTimeoutInSeconds;
                }
                ...
                if (coinService is BitcoinService)
                {
                    ...
                    {
                        DaemonUrl = LibConfig.Bitcoin_DaemonUrl;
                        DaemonUrlTestnet = LibConfig.Bitcoin_DaemonUrl_Testnet;
                        RpcUsername = LibConfig.Bitcoin_RpcUsername;
                        RpcPassword = LibConfig.Bitcoin_RpcPassword;
                        WalletPassword = LibConfig.Bitcoin_WalletPassword;
                    }
