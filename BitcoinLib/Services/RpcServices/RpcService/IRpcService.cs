...
namespace BitcoinLib.Services.RpcServices.RpcService
{
    ...
    {
        string GetRawJsonQuery(string query, params object[] parameters);
        #region Blockchain

        string GetBestBlockHash();
        GetBlockResponse GetBlock(string hash, bool verbose = true);
        List<string> GetOmniListBlockTransactions(long index);
        ...
        GetInfoResponseMoney GetInfoMoney();
        GetInfoResponseLight GetInfoLight();
        ...
        GetNetworkInfoResponseLight GetNetworkInfoLight();
        List<GetPeerInfoResponse> GetPeerInfo();

        //budget
        List<GetBudgetResponse> GetBudgetInfo();
        List<GetBudgetResponse> GetBudgetProjection();
        List<GetBudgetVotesResponse> GetBudgetVotes(string budgetName);
        long GetNextSuperBlock();
        ...
        GetOmniTransactionResponse GetOmniTransaction(string txId);
        ...
        List<MasternodeFullResponse> MasternodesList();
        List<MasternodeRemoteResponse> MasternodesRemoteList();
